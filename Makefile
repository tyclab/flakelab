...
test:
	@rc=0; for suite in test-clone-repos test-gitchecker test-gitcleaner test-gitpublisher test-nix-backup test-nix-overlay-generate test-flakelab-cli test-claude-sessions test-nix-update test-switch-result; do \
		echo "==> $$suite"; \
