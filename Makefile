...
test:
	@rc=0; for suite in test-clone-repos test-gitchecker test-gitcleaner test-gitpublisher test-nix-backup test-nix-overlay-generate test-flakelab-cli test-claude-sessions test-accounts test-notify test-web test-nix-update test-nix-doctor test-switch-result test-xdg-open; do \
		echo "==> $$suite"; \
